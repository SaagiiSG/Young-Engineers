...
const Navbar = () => {
    ...
    <nav className='w-full flex flex-row items-center justify-between py-3 px-8 fixed bg-[#01093a] z-10'>
        <div className='flex flex-row items-center font-sans text-slate-100 gap-4'>
            ...
            <h1 className='text-center font-medium'>Young Engineers <br/>  Mongolia</h1>
        </div>
        <div className='text-slate-100 flex flex-row gap-4 font-medium text-xl'>
            ...
            <Link to='/Academy' className='hover:scale-110 duration-200 hover:text-slate-200' >Academy</Link>
